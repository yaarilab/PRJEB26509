...
input:
 set val(name),file(reads) from g_2_reads_g_87
 val mate from g_1_mate_g_87

output:
 set val(name),file("*.fastq")  into g_87_reads0_g9_0
...
input:
 set val(name),file(reads) from g_87_reads0_g9_0
